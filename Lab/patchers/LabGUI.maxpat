...
, 			{
				"box" : 				{
					"comment" : "Track Pane Button",
					"id" : "obj-16",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1331.891591519117355, 366.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 137.21104471385479, 132.416666567325592, 44.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 137.21104471385479, 149.416666567325592, 60.666665852069855, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
							"parameter_invisible" : 2,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 102.73932485931968, 149.076008051633835, 15.0, 15.0 ],
					"remapsvgcolors" : 1,
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 202.954633936285973, 2.916666567325592, 294.995157956700268, 166.609093174486162 ],
					"proportion" : 0.39,
					"saved_attribute_attributes" : 					{
						"bgfillcolor" : 						{
							"expression" : "themecolor.live_lcd_bg"
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 123.188330858945847, 5.600877106189728, 5.0, 159.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"annotation_name" : "Show Track Pane",
					"automation" : "Closed",
					"automationon" : "Open",
					"fontname" : "Ableton Sans Book",
					"fontsize" : 9.17,
					"hint" : "Reveal the track pane.",
					"id" : "obj-119",
					"maxclass" : "live.text",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1333.391591519117355, 296.013816509097751, 20.0, 20.0 ],
					"pictures" : [ "sr-arrow-down-11x11.svg", "sr-arrow-right-11x11.svg" ],
					"presentation" : 1,
					"presentation_rect" : [ 182.877710565924644, 6.916666567325592, 15.0, 15.0 ],
					"remapsvgcolors" : 1,
					"rounded" : 15.0,
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_annotation_name" : "Show Track Pane",
							"parameter_enum" : [ "Closed", "Open" ],
							"parameter_info" : "This button shows/hides the speaker setup and output channel configuration section.",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.914956144033425, 149.076008051633835, 97.824368715286255, 15.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
